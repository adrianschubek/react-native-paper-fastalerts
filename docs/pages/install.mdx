...
<video width={256} loop autoPlay muted playsinline src={"/install-quickstart-light.mp4"} />
<video width={256} loop autoPlay muted playsinline src={"/install-quickstart-dark.mp4"} />
